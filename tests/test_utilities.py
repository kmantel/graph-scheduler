...
nx_digraph_types = [
    ...
    if (
        inspect.isclass(t)
        and issubclass(t, nx.DiGraph)
        # PlanarEmbedding has a different interface than other DiGraphs
        # since networkx 3.3, disallowing add_edge and requiring more
        # complicated use of add_half_edge
        and not issubclass(t, nx.PlanarEmbedding)
    )
]
